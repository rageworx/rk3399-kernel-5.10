...
static struct proc_ops boardver_ops = {
	.proc_open	= ver_open,
	.proc_read	= seq_read,
};

static struct proc_ops boardinfo_ops = {
	.proc_open	= info_open,
	.proc_read	= seq_read,
};

static struct proc_ops boardmodel_ops = {
	.proc_open	= model_open,
	.proc_read	= seq_read,
};

static struct proc_ops boardid_ops = {
	.proc_open	= bid_open,
	.proc_read	= seq_read,
};

static struct proc_ops projectid_ops = {
	.proc_open	= pid_open,
	.proc_read	= seq_read,
};

static struct proc_ops ddr_ops = {
	.proc_open   = ddr_open,
	.proc_read   = seq_read,
};
